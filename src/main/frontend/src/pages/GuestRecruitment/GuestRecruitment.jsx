...
import GuestPlayerRecruitment from "../../containers/GuestPlayerRecruitment/GuestPlayerRecruitment";
        ...
        <div className={styles["guestrecruitment-grid"]}>
            ...
            {isModalOpen && (
                <Modal isOpen={isModalOpen} closeModal={() => setIsModalOpen(false)}>
                    ...
                    <Button color="var(--main-color)" to={`/guestplayer/${reservationList[isSelected]?.reservationNumber}/new`}>
                        확인
                    </Button>
                </Modal>
            )}
