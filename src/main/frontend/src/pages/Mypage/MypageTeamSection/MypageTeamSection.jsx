...
import styles from './MypageTeamSection.module.css';
...
const MypageTeamSection = ({ gridArea }) => {
    ...
    <div style={{ gridArea: gridArea }}>
      <div className={styles.content}>
        ...
        <div className={styles.actbox}>
          ...
          <Teaminfo formFields={formFields} id={user.id} team={teamState.teamCode} />
        </div>
      </div>
    </div>
  );
...
export default MypageTeamSection;
